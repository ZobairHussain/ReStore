...
namespace API.Data.Migrations
{
    ...
    [Migration("20220513040516_PaymentIntentAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OrderAggregate.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "bed47059-10f9-44aa-b681-0e6fb21584ed",
                            Name = "Member",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "1364d78f-20fd-47d9-879b-1f84e7a243dc",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        });
                });

            modelBuilder.Entity("API.Entities.OrderAggregate.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.OrderAggregate.UserAddress", b =>
                {
                    b.HasOne("API.Entities.User", null)
                        .WithOne("Address")
                        .HasForeignKey("API.Entities.OrderAggregate.UserAddress", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("API.Entities.OrderAggregate.Role", null)
                        .WithMany()
